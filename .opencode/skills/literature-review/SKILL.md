...
description: 写文献综述 / 系统综述。围绕一个主题多路检索文献，去重、按研究类型(RCT/队列/meta等)和主题归类，综合成有结构、有引用的综述（引言→分主题证据→争议与空白→结论），并给出参考文献表。当用户说"写综述""文献综述""系统综述""某主题研究进展""帮我综述一下"时使用。边界：本技能产出**成文的、有引用的综述**；只要一份**文献清单/BibTeX**用 search-lit；只要**快速摸底不成文**用 research-scan。
---
