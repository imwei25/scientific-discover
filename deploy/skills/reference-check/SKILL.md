...
.venv/bin/python .opencode/skills/reference-check/verify_refs.py --input outputs/refs.bib

# 或直接给几个 DOI / PMID / 标题
.venv/bin/python .opencode/skills/reference-check/verify_refs.py "10.1038/xxx" "PMID:12345678" "某篇论文标题"
```
